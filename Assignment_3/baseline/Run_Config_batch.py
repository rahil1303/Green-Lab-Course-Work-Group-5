...
class RunnerConfig:
    ...
    def __init__(self):
        ...
        self.BATCH_SIZE = 36  # 36 runs per batch = 324/9 batches
    ...
    def create_run_table_model(self) -> RunTableModel:
        ...
        Returns:
            RunTableModel: Model...
        """
        # Define experimental factors (6 subjects as per report)
        ...
        # Total runs: 6 subjects × 3 GC × 3 workload × 2 JDK × 3 reps = 324 runs
    ...
    def before_run(self) -> None:
        ...
        # Check if we need to pause for batch boundary
        if self.runs_in_batch >= self.BATCH_SIZE:
            output.console_log("")
            output.console_log("╔" + "═"*58 + "╗")
            output.console_log(f"║  BATCH {self.current_batch} COMPLETE - {self.BATCH_SIZE} runs executed" + " "*11 + "║")
            output.console_log("║" + " "*58 + "║")
            output.console_log("║  Pausing for batch review..." + " "*28 + "║")
            output.console_log("║  Press ENTER to continue with next batch" + " "*15 + "║")
            output.console_log("║  Or press Ctrl+C to stop experiment" + " "*20 + "║")
            output.console_log("╚" + "═"*58 + "╝")
