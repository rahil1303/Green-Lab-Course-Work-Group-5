...
class RunnerConfig:
    ...
    time_between_runs_in_ms:    int             = 120000  # 2 mins cooldown
    ...
    def __init__(self):
        ...
        self.BATCH_SIZE = 6  # Run 36 experiments at once
    ...
    def create_run_table_model(self) -> RunTableModel:
        ...
        self.run_table_model = RunTableModel(
            ...
            exclude_combinations=[],  # No exclusions
    ...
    def before_experiment(self) -> None:
        ...
        total_runs = len(self.run_table_model.generate_experiment_run_table())
    ...
    def start_run(self, context: RunnerContext) -> None:
        ...
        output.console_log("="*60)
        output.console_log(f"Subject:  {context.execute_run['subject']}")
        output.console_log(f"GC:       {context.execute_run['gc']}")
        output.console_log(f"Workload: {context.execute_run['workload']}")
        output.console_log(f"JDK:      {context.execute_run['jdk']}")
        output.console_log(f"Rep:      {context.execute_run['__run_id']}")
        output.console_log("")
    ...
    def start_measurement(self, context: RunnerContext) -> None:
        ...
        gc = context.execute_run['gc']
        workload = context.execute_run['workload']
        jdk = context.execute_run['jdk']
        rep = context.execute_run['__run_id'].split("-")[-1]
