...
class RunnerConfig:
    ...
    def start_run(self, context: RunnerContext) -> None:
        ...
        if "__rep__" in context.execute_run:
                output.console_log(f"Rep:      {context.execute_run['__rep__']}")
        else:
                output.console_log("Rep: not defined")
    ...
    def start_measurement(self, context: RunnerContext) -> None:
        ...
        rep = context.execute_run.get("__rep__", 1)
